...
var store1stPike = {
  ...
  customerGen : function (){
    for (i = 0; i < 15; i++) {
      //this.customerCapacity.push
      (Math.floor(Math.random()*(this.storeMax-this.storeMin)+this.storeMin*this.storeAvg));
    }
  },
  customerCapacity:[this.customerGen()],


  clientStoreInfo : function (){
    for (i = 0; i < 15; i++){
      storeContent[i] = document.createElement('div');
      storeContent[i].textcontent = store1stPike.customerCapacity[i];
    }
  }
};

var pikeTotal = store1stPike.customerCapacity.reduceRight(function(a,b){return a+b;});
...
console.log('Total:' + store1stPike.total);
